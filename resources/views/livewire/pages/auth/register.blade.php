...
<div>
    <form wire:submit="register" class="space-y-4">
        <!-- Name -->
        <x-form.group name="name" wire:model="name" required autofocus autocomplete="name" />

        <!-- Email Address -->
        <x-form.group name="email" type="email" wire:model="email" required autocomplete="username" />
